//
//  FKLPageCollectionViewLayout.swift
//  FKLTV
//
...
class FKLPageCollectionViewLayout: UICollectionViewFlowLayout {
    var cols: Int = 4
    var rows: Int = 2
...
extension FKLPageCollectionViewLayout {
    override func prepare() {
        ...
        for i in 0..<sectionCount {
            ...
            for j in 0..<itemCount {
                ...
                arrt.frame = CGRect(x: itemX, y: itemY, width: itemW, height: itemH)
                cellAttrs.append(arrt)
            }
